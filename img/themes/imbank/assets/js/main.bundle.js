    ...
    i.n = e => {
        ...
        ! function(e) {
            const i = window,
                ...
                z = document.querySelectorAll(".card-type-4"),
                L = document.querySelectorAll(".card-type-5"),
                I = document.querySelectorAll(".card-type-10"),
                F = document.querySelectorAll(".card-type-12"),
                M = document.querySelectorAll(".card-type-14"),
                D = document.querySelectorAll(".card-type-22"),
                H = document.querySelectorAll(".card-type-26"),
                $ = document.querySelectorAll(".card-type-33"),
                V = document.querySelectorAll(".card-type-35"),
                ...
                ye = {
                    ...
                    slider2: () => {
                        if (q.length) {
                            le(q).forEach((t => {
                                let i = e(t),
                                    o = (i.closest(".page-section"), i.closest(".carousel-layout-2-container")),
                                    n = o.find(".swiper-pagination"),
                                    s = i.data("slides-view"),
                                    r = null == s || "" == s ? 2 : s,
                                    l = o[0].querySelector(".swiper-button-prev"),
                                    c = o[0].querySelector(".swiper-button-next");
                                new a.default(t, {
                                    loop: !0,
                                    slidesPerView: 1,
                                    pagination: {
                                    ...
                                    on: {
                                        afterInit: function(t) {
                                            e(t.$el[0]).find(".card-type-5") && me(e(t.$el[0]).find(".card-type-5"), ".card-type-5-title")
                                        }
                                    }
                                })
                            }))
