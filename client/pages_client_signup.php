...
?>
  ...
  <body class="hold-transition login-page" style="background-color: #2D2D2D;">
    <div class="login-box">
      <div class="login-logo">
        <p style="color: white;"><?php echo $auth->sys_name; ?> - Sign Up</p>
      </div>
      <!-- /.login-logo -->
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg" style="color: black;" >Sign Up To Damey Banking System </p>
          ...
          <form method="post">
            ...
            <div class="input-group mb-3">
              <input type="text" name="address" required class="form-control" placeholder="P.O Box  Address">
              <div class="input-group-append">
                <div class="input-group-text">
